        ...
        for sale_bon_commande in sale_a_cree_bon_commande:
            if sale_bon_commande.partner_id.augmentation_sav_bool == True:
                if sale_bon_commande.date_last_cout_update_vrai + relativedelta(years=1) <= date.today()+relativedelta(days=1):
                    ...
                    sale_bon_commande.sale_cout_actuel_col = sale_bon_commande.sale_cout_actuel_col + sale_bon_commande.sale_cout_actuel_col*sale_bon_commande.partner_id.augmentation_sav
                ...
                if sale_bon_commande.sale_date_Facture:
                    if sale_bon_commande.sale_periode:
                        if sale_bon_commande.sale_periode == 1:
                            if sale_bon_commande.sale_date_Facture + relativedelta(months=1)-relativedelta(days=1) <= date.today() and sale_bon_commande.sale_date_Facture <=sale_bon_commande.sale_date_de_fin_contrat:

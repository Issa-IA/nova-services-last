...
class   Crmteamoinhertit(models.Model):
    ...
    crm_team_comer = fields.Monetary("MARGE COMMERCIALE")
    crm_team_chif = fields.Monetary("CHIFFRE D'AFFAIRE")
    crm_team_reel = fields.Monetary("MARGE REELLE")
    crm_team_livraison = fields.Monetary("FRAIS DE LIVRAISON")
    crm_team_N_client = fields.Integer("NB NEW")
    crm_team_N_contrat= fields.Integer("NB CONTRAT")
    crm_team_N_materiel= fields.Integer("NB MATERIELS")

...
class StockHerit(models.Model):
    ...
    etiquette_maintenance = fields.Selection([('maintenance', 'Maintenance'), ('autres', 'Autres'),('cvi','CVI'),('import','Import CVI')], compute='_maintenance_etiquette', readonly=False,  store=True)

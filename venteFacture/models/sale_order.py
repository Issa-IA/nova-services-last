            ...
            if sale_order_id.sale_periode in [1,3]:
                ...
                if new_date <= date.today():
                    ...
                    for so_to_inv_id in sale_orders_to_invoice_ids:
                        invoice_lines = []
                        if so_to_inv_id.sale_commande_fleet_ids[0].fleet_id.fleet_devis_id.id == sale_order_id.id or (so_to_inv_id.sale_connect and so_to_inv_id.sale_connect.id == sale_order_id.id):
